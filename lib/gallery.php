...
if (current_theme_supports('bootstrap-gallery')) {
  ...
  add_shortcode('gallery', 'canvas_gallery');
 ...
 */
function canvas_attachment_link_class($html) {
  $html = str_replace('<a', '<a class="thumbnail img-thumbnail"', $html);
  return $html;
}
add_filter('wp_get_attachment_link', 'canvas_attachment_link_class', 10, 1);
